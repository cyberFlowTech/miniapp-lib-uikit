Pod::Spec.new do |s|
  ...
  DESC
  s.homepage         = 'https://github.com/cyberFlowTech/miniapp-lib-uikit'
  s.license          = { :type => 'MIT', :file => 'LICENSE.md' }
  s.author           = { 'cyberFlowTech' => 'xxx@example.com' }
  s.ios.deployment_target = "13.0"
  s.swift_version    = '5.0'
  s.source           = { :git => 'https://github.com/cyberFlowTech/miniapp-lib-uikit.git', :tag => s.version.to_s }
